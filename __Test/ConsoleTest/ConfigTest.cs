...
namespace ConsoleTest {
    internal class ConfigTest {
        ...
        public void RegisterTest() {
            ...
            _cfg.TryRegister<ConfigOne>(); //RegisterTest Config
        ...
        public async Task SaveConfigTest() {
            await _cfg.Save<ConfigTwo>(); //This will call a specific config and save it.
            await _cfg.Save<ConfigOne>(); //This will call a specific config and save it.
        }
